...
Final Seed Audio prompts are not raw JSON dumps. The final audio storyboard is rewritten using the companion `doubao-seed-audio` skill's Audio Director Prompting guidance before generation.
